...
export function SchoolPaymentReverseDialog({
    open,
    payment,
    loading,
    onCancel,
            ...
            <AlertDialogContent>
                ...
                <AlertDialogHeader>
                    <AlertDialogTitle className="text-red-600 underline underline-offset-2">
                        Reverse School Payment?
                    </AlertDialogTitle>

                    <AlertDialogDescription className="text-sm text-slate-600 leading-relaxed">
                        You are about to reverse the payment received from the school
                        ...
                        <span className="text-slate-500">
                            The amount will be removed from school statements.
                        </span>
                    </AlertDialogDescription>
                </AlertDialogHeader>
