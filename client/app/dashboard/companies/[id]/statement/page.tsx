...
import { useCompanyStatement } from "@/lib/queries/company";
import CompanyStatementPdf from "@/components/pdf/CompanyStatementPDF";
...
export default function CustomerStatementPage() {
    ...
    const { data, isLoading } = useCompanyStatement(id);
    ...
    if (!data.rows.length) return (
        <EmptyState
            ...
            actionHref={`/dashboard/companies/${id}/invoices`
            }
        />
    )
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex justify-end">
                <PDFDownloadLink
                    document={<CompanyStatementPdf data={data} settings={settings} />}
            ...
            <div className="h-[90vh] border bg-white rounded">
                <PDFViewer width="100%" height="100%">
                    <CompanyStatementPdf data={data} settings={settings} />
                </PDFViewer>
            </div>
        </div>
    );
