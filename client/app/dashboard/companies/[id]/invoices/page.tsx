    ...
    if (!data.length) {
        return (
            <EmptyState
                ...
                description="No invoices created for this company yet."
                actionLabel="Create Invoice"
                actionHref={`/dashboard/companies/${id}/invoices/new`}
            />
        );
    }
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:justify-between  md:items-center gap-4">
                ...
                <button
                    onClick={() =>
                        router.push(`/dashboard/companies/${id}/invoices/new`)
                    }
            ...
            <ResponsiveTable
                ...
                onRowClick={(row) =>
                    router.push(
                        `/dashboard/companies/${id}/invoices/${row.id}`
                    )
                }
            />
