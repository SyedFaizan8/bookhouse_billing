...
import { useCompanyCreditNote } from "@/lib/queries/company";
...
export default function CustomerInvoicesPage() {
    ...
    const { data = [], isLoading } = useCompanyCreditNote(id);
    ...
    if (!data.length) {
        return (
            <EmptyState
                ...
                description="No Credit Note created for this company yet."
                actionLabel="Create Credit Note"
                actionHref={`/dashboard/companies/${id}/credit/new`}
            />
        );
    }
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:justify-between  md:items-center gap-4">
                ...
                <button
                    onClick={() =>
                        router.push(`/dashboard/companies/${id}/credit/new`)
                    }
            ...
            <ResponsiveTable
                ...
                onRowClick={(row) =>
                    router.push(
                        `/dashboard/companies/${id}/credit/${row.id}`
                    )
                }
            />
